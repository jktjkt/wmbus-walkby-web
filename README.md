...
![Demo](doc/2025-12-03-wmbus-walkby.webp "Demo")
...
The log can be post-processed and fed to [`wmbusmeters`](https://github.com/wmbusmeters/wmbusmeters) for further decoding.
